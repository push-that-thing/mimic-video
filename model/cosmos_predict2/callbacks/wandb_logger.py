        ...
        return self._jsonable(
            {
                ...
                "data": {
                    ...
                    "num_val_episodes": self._get("dataloader_train", "dataset", "num_val_episodes"),
                    "val_ratio": self._get("dataloader_train", "dataset", "val_ratio"),
                ...
                "training": {
                    ...
                    "max_val_iter": self._get("trainer", "max_val_iter"),
                    ...
                    "validation_mode": self._get("model", "config", "validation_mode"),
                },
                "video_backbone": {
